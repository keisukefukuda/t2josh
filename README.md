...
produces the below
   ...
   #!/bin/sh
   #----------------------------------------------
   # Generated by 9deg at 2011-11-07 18:20:06.572646
   # in directory /home0/usr1/11M37264/github/9deg
   # t2sub -q S -W group_list=t2g-yourgroup -l select=1 /home/usr1/11M37264/.9deg/111107182006_560.sh
   # /home/usr1/11M37264/.9deg/111107182006_560.sh
   cd ${PBS_O_WORKDIR}
...
$ ./9deg -n 8x4 -g t2g-yourgroup -q S ./a.out --dry
   ...
   #!/bin/sh
   #----------------------------------------------
   # Generated by 9deg at 2011-11-07 18:20:06.628394
   # in directory /home0/usr1/11M37264/github/9deg
   # t2sub -q S -W group_list=t2g-yourgroup -l select=4:mpiprocs=8:ncpus=8 /home/usr1/11M37264/.9deg/111107182006_60.sh
   # /home/usr1/11M37264/.9deg/111107182006_60.sh
   cd ${PBS_O_WORKDIR}
...
$ ./9deg --openmp=4 -g t2g-yourgroup -q S ./a.out --dry
   ...
   #!/bin/sh
   #----------------------------------------------
   # Generated by 9deg at 2011-11-07 18:20:06.683681
   # in directory /home0/usr1/11M37264/github/9deg
   # t2sub -q S -W group_list=t2g-yourgroup -l select=1:ncpus=4 /home/usr1/11M37264/.9deg/111107182006_561.sh
   # /home/usr1/11M37264/.9deg/111107182006_561.sh
   cd ${PBS_O_WORKDIR}
...
$ ./9deg -n 4x4x2 -g t2g-yourgroup -q S ./a.out --dry
   ...
   #!/bin/sh
   #----------------------------------------------
   # Generated by 9deg at 2011-11-07 18:20:06.739569
   # in directory /home0/usr1/11M37264/github/9deg
   # t2sub -q S -W group_list=t2g-yourgroup -l select=2:mpiprocs=4:ncpus=16 /home/usr1/11M37264/.9deg/111107182006_61.sh
   # /home/usr1/11M37264/.9deg/111107182006_61.sh
   cd ${PBS_O_WORKDIR}
