...
produces the below
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:24:46.296867
     # in directory /home0/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=1 /home/00M00000/.9deg/111107192446_160.sh
     # /home/00M00000/.9deg/111107192446_160.sh
     cd ${PBS_O_WORKDIR}
...
produces:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:24:46.394501
     # in directory /home0/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=4:mpiprocs=8:ncpus=8 /home/00M00000/.9deg/111107192446_940.sh
     # /home/00M00000/.9deg/111107192446_940.sh
     cd ${PBS_O_WORKDIR}
...
produces:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:24:46.461669
     # in directory /home0/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=1:ncpus=4 /home/00M00000/.9deg/111107192446_440.sh
     # /home/00M00000/.9deg/111107192446_440.sh
     cd ${PBS_O_WORKDIR}
...
produces:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:24:46.530949
     # in directory /home0/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=2:mpiprocs=4:ncpus=16 /home/00M00000/.9deg/111107192446_110.sh
     # /home/00M00000/.9deg/111107192446_110.sh
     cd ${PBS_O_WORKDIR}
