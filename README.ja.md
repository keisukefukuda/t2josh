...
この出力は下のようになります
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:31:10.078866
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=1 /home/usr1/00M00000/.9deg/111107193110_360.sh
     # /home/usr1/00M00000/.9deg/111107193110_360.sh
     cd ${PBS_O_WORKDIR}
...
出力:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:31:10.148940
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=4:mpiprocs=8:ncpus=8 /home/usr1/00M00000/.9deg/111107193110_920.sh
     # /home/usr1/00M00000/.9deg/111107193110_920.sh
     cd ${PBS_O_WORKDIR}
...
出力:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:31:10.218952
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=1:ncpus=4 /home/usr1/00M00000/.9deg/111107193110_560.sh
     # /home/usr1/00M00000/.9deg/111107193110_560.sh
     cd ${PBS_O_WORKDIR}
...
出力:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-11-07 19:31:10.289137
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=2:mpiprocs=4:ncpus=16 /home/usr1/00M00000/.9deg/111107193110_60.sh
     # /home/usr1/00M00000/.9deg/111107193110_60.sh
     cd ${PBS_O_WORKDIR}
