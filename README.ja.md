...
この出力は下のようになります
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-12-27 18:06:47.737511
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=1 /home/usr1/00M00000/.9deg/111227180647_510.sh
     # /home/usr1/00M00000/.9deg/111227180647_510.sh
     cd ${PBS_O_WORKDIR}
...
出力:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-12-27 18:06:47.850301
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=4:mpiprocs=8:ncpus=8 /home/usr1/00M00000/.9deg/111227180647_10.sh
     # /home/usr1/00M00000/.9deg/111227180647_10.sh
     cd ${PBS_O_WORKDIR}
...
出力:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-12-27 18:06:47.931080
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=1:ncpus=4 /home/usr1/00M00000/.9deg/111227180647_511.sh
     # /home/usr1/00M00000/.9deg/111227180647_511.sh
     cd ${PBS_O_WORKDIR}
...
出力:
     ...
     #!/bin/sh
     #----------------------------------------------
     # Generated by 9deg at 2011-12-27 18:06:48.019035
     # in directory /home0/usr1/00M00000/github/9deg
     # t2sub -q S -W group_list=t2g-yourgroup -l select=2:mpiprocs=4:ncpus=16 /home/usr1/00M00000/.9deg/111227180648_50.sh
     # /home/usr1/00M00000/.9deg/111227180648_50.sh
     cd ${PBS_O_WORKDIR}
